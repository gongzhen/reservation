package com.zhengong.reservation.landon.web.application;

import com.zhengong.reservation.landon.business.domain.RoomReservation;
import com.zhengong.reservation.landon.business.service.ReservationService;
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception {
        Date date = (Date) DATE_FORMAT.parse("2017-01-01");
